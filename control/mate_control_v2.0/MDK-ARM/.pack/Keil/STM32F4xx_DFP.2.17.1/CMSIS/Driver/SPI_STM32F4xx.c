 ...
 *    (RX Not Empty interrupt was happening during DMA reception)
 *  Version 2.16
...
#define ARM_SPI_DRV_VERSION ARM_DRIVER_VERSION_MAJOR_MINOR(2,18)
...
static void SPI_RX_DMA_Complete(const SPI_RESOURCES *spi) {
  ...
  // Enable Rx Not Empty interrupt, it is used to allow data lost detection before new transfer is started
  spi->reg->CR2 |= SPI_CR2_RXNEIE;
